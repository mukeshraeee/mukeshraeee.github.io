...
From August 23–27, 2021, a regional virtual training on snow data analysis in the HKH region using R and GEE software was held. We had 31 participants in total, of whom 11 were nominated by our partner organizations from the HKH region and the remaining 20 were chosen from the applications submitted in response to the open call. We received 156 applications for the 20 open call jobs. The training addressed a variety of snow-related subjects, such as field-based snow data measurement, snow remote sensing, and the dominant snow process across the HKH region. The use and advantages of open-source software, particularly R and Google Earth Engine (GEE), for the analysis of snow data were explained, demonstrated to the students and participants. The participants received hands-on training every day to help them use R and GEE software to address their own problems.
